...
.first-section .first-section-main .card {
  background: #ffffff;
...
.first-section .first-section-main .card img {
  width: 100%;
  border-radius: 8px 8px 0 0;
}

.first-section .first-section-main .card img.video-img {
  border: none;
  width: 2rem;
  position: absolute;
  left: 0.1rem;
...
.first-section .first-section-main .card img.wish-icon {
  border: none;
  width: 2.3rem;
  position: absolute;
  right: 0.1rem;
...
.first-section .first-section-main .card .card-body {
  padding: 0.5rem;
}
