...
.filter-dialog :deep(.el-dialog .el-dialog__footer) {
...
.filter-dialog :deep(.el-dialog .second-section .el-row:not(:last-of-type)) {
  margin-bottom: 1rem;
}

.filter-dialog :deep(.el-dialog .top-section .title),
.filter-dialog :deep(.el-dialog .bottom-section .title),
.filter-dialog :deep(.el-dialog .second-section .title) {
  display: flex;
  align-items: center;
  justify-content: space-between;
  margin-bottom: 1rem;
...
.filter-dialog :deep(.el-dialog .second-section .title img) {
  width: 1.5rem;
}

.filter-dialog :deep(.el-dialog .top-section .title p),
.filter-dialog :deep(.el-dialog .bottom-section .title p),
.filter-dialog :deep(.el-dialog .second-section .title p) {
  font-family: Noto Sans TC, PingFang, Helvetica, Arial, sans-serif, serif;
  font-style: normal;
  font-weight: 500;
  font-size: 14px;
...
.filter-dialog :deep(.el-dialog .second-section .box) {
  background: #f5f5f5;
...
.filter-dialog :deep(.el-dialog .second-section) {
  margin-top: 1rem;
}
